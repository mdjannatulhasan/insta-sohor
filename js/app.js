...
const displayContent = (text) => {
    return text.length < 30 ? text : text.slice(0, 30) + "<span class='fw-bold'>... read more</span>"; //here was a bug
};
              ...
              <div class="post__header">
                <div class="post__profile">
                  <a
                    ...
                    class="post__avatar"
                  >
                    <img src="${post.userImage}" alt="User Picture" /> <!-- here was a bug -->
                  </a>
                  ...
                  <div class="post__description">
                    <small>
                      <a class="post__name--underline" href="#">
                          ${post.comments[0]?.user} <!-- here was a bug -->
                      </a>
...
const displayReportedPosts = () => {
    ...
    reportedPosts.forEach((post) => {  //here was a bug
        const div = createPost(post);
